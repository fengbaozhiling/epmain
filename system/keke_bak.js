	...
	if(typeof(INDEX)!="undefined"){
		...
		switch(INDEX){
			case 'shop':
				...
				$.post(ajax_user_url,{sid:sid,ac_url:ac_url,http_host:http_host,request_uri:request_uri,art_id:art_id},function(json){
					if(json.status){
...
function load_header_top() {
	var header_top_left = '<span class="pl_5"><a class="s_lz" href="/zt/APPS/android/" target="_blank"><img style="vertical-align:-2px; margin-right:5px;" src="/tpl/default/theme/simple/img/system/ico-12x150.png" alt="手机版"/>手机版</a>&nbsp;|&nbsp;欢迎您,'+
		...
		var header_right = '<div class="logintolinner fl_l">'+
								'<div class="loginlitb_name">'+
									'<div class="loginlitb_topname">'+
										...
										"<span id='top_u_pic'><img alt='会员登陆' src='http://www.epweike.net/tpl/default/theme/simple/img/2013/defalheid.jpg' original-title=''></span>任务管理"+
									'</div>'+
									'<div class="loginlitb_box" style="display:none;">'+
										'<div class="afterlogin_task">'+
											'<ul>'+
												'<li><a href="'+SITEURL+'/user-view-employer-op-task-opp-xsrw.html" target="_blank">&gt;&nbsp;&nbsp;我发布的任务</a></li>'+
												'<li><a href="'+SITEURL+'/user-view-witkey-op-task-opp-xsrw.html" target="_blank">&gt;&nbsp;&nbsp;我参加的任务</a></li>'+
												'<li><a href="'+SITEURL+'/index.php?do=user&view=message" target="_blank">&gt;&nbsp;&nbsp;我的站内信<span id="messagecount_2"></span></a></li>'+
												'<li><a href="'+SITEURL+'/index.php?do=user&view=witkey&op=collect" target="_blank">&gt;&nbsp;&nbsp;收藏夹</a></li>'+
											'</ul>'+
										'</div>'+
									'</div>'+
								'</div>'+
							...
							'<div class="logintolinner logintooset fl_r">'+
								'<div class="loginlitb_name">'+
									...
									'<div class="loginlitb_box" style="display:none;">'+
										'<div class="afterlogin_task">'+
											'<ul>'+
												'<li><a href="'+SITEURL+'/index.php?do=user&view=finance&op=detail" target="_blank">&gt;&nbsp;&nbsp;财务明细</a></li>'+
												'<li><a href="'+SITEURL+'/index.php?do=user&view=finance&op=recharge" target="_blank">&gt;&nbsp;&nbsp;我要充值</a></li>'+
												'<li><a href="'+SITEURL+'/index.php?do=user&view=finance&op=withdraw" target="_blank">&gt;&nbsp;&nbsp;我要提现</a></li>'+
											'</ul>'+
										'</div>'+
									'</div>'+
								'</div>'+
